...
- 진행 중: **쌀나눔 시트 → StorySection 통계 자동 반영** (branch `feat/rice-sheet-sync`) — 디테일 `docs/plans/active/TASK-20260828-rice-sheet-sync.md`. ADR-058/060. 배포 시 마이그레이션 0020·0021·0022 + `RICE_SHEET_CSV_URL` + GHA 수동 1회 필요.
