...
> - 홈 1920/1024 자식 frame ID 변경 (`126:11815`→`331:7984`, `126:10980`→`332:9254`). 1439 자식 frame 삭제 (1440에 통합).
...
- **최근 확인 날짜**: 2026-06-03 (반응형 매트릭스 정정 — 아래 §반응형 컴포지션 매트릭스 정정 노트) / 2026-05-30 / 2026-05-26
...
| 1439~1025 | Desktop | `97:8573` (1025) | (1439 시안 삭제) | **1439 자식 frame 사라짐 — 1025로 통합** |
...
> - **KpiSection**: 768~1023 = KpiCard **2x2 단순 그리드**(벤토 아님 — 고정폭 데코 오버플로 회피), 1024↑ = 벤토. 375~767 = **1열**(640↑ 2열).
...
> - **HeroBanner**: lg 미만은 *세로 스택이 아니라* flower 를 우측 absolute 배경으로 겹치는 Method B 유지(Figma 전 폭 가로 겹침 구도). "세로 스택?"은 과잉 보수 오류.
