...
export const ADMIN_COPY = {
  ...
  nav: {
    ...
    brandSub: "사회공헌국 전용",
    dashboard: "대시보드",
    // 숫자로 보는 참사랑 실천 (구 '메인 페이지' KPI) — 공개 섹션명과 그룹명 일치
    groupNumbers: "숫자로 보는 참사랑 실천",
    kpi: "데이터 관리",
    ...
    categories: "스토리 카테고리",
    // 언론 속 사회공헌 (별도 게시판 — 카테고리 + 글 관리, 대표글 없음)
    groupPress: "언론 속 사회공헌",
    press: "언론 보도 관리",
    pressCategories: "언론 카테고리",
    // 공지사항 (공지 CRUD + 첨부파일)
    groupNotices: "공지사항",
    notices: "공지사항 관리",
    // 팝업 (홈 화면 안내 팝업)
  ...
  // ─── 숫자로 보는 참사랑 실천 (구 KPI/임팩트 데이터) ───
  kpi: {
    title: "숫자로 보는 참사랑 실천",
    description:
      "메인 페이지 '숫자로 보는 참사랑 실천'에 보이는 숫자예요. 저장하면 사용자 사이트에 바로 반영됩니다.",
  ...
  mainStory: {
    ...
    visibleCountTitle: "메인 페이지에 보여줄 개수",
    visibleCountHelp:
      "사용자 메인 페이지에 실제로 보이는 카드 수예요. 아래에서 자리는 12개까지 정해둘 수 있고, 여기서 고른 개수만큼만 화면에 나옵니다. 남겨둔 자리는 대기하다가 개수를 늘리면 바로 노출돼요.",
  },
  ...
  popups: {
    title: "팝업 관리",
    description: "홈 화면에 표시할 안내 팝업을 등록하고 노출 기간을 관리합니다.",
    displayHelp: "여러 팝업이 활성이면 시작일이 최근인 1개만 노출됩니다.",
    imageHelp: "세로형 4:5 내외 이미지를 권장하며, 가로 720px 이상을 사용하세요. 5MB를 초과한 이미지는 자동으로 축소됩니다.",
    linkHelp: "링크를 넣으면 이미지 클릭 시 해당 페이지로 이동합니다. /로 시작하는 내부 경로 또는 https:// 주소를 입력하세요.",
    linkTargetLabel: "링크 열기 방식",
    linkTargetHelp:
      "현재 탭은 이 페이지에서 바로 이동하고, 새 탭은 현재 화면을 유지합니다. 작은 새 창은 480px 너비로 열어 안내를 계속 볼 수 있어 추천합니다.",
    dismissDurationLabel: "다시 보지 않기 기간",
    dismissHelp:
      "방문자가 팝업 하단의 '보지 않기'를 체크하고 닫았을 때 숨길 기간이에요. 고른 기간에 맞춰 체크박스 문구도 '하루 동안 보지 않기' 또는 '일주일간 보지 않기'로 바뀝니다. 브라우저별로 저장되므로 다른 기기나 시크릿 창에서는 다시 보일 수 있어요.",
  },
  ...
  // ─── 언론 속 사회공헌 (별도 게시판 — 활동 스토리와 글·카테고리가 완전히 분리, ADR-056) ───
  press: {
    title: "언론 보도 관리",
    description: "언론에 소개된 사회공헌 활동을 등록하고 발행합니다.",
  },
  pressCategories: {
    title: "언론 카테고리",
    description:
      "언론 속 사회공헌 페이지의 탭을 관리합니다. 순서를 드래그로 바꾸면 탭 순서도 그대로 바뀝니다.",
    titleHelp:
      "언론 보도를 묶는 주제예요. 활동 스토리 카테고리와는 별개로 관리되며, 같은 이름을 양쪽에 각각 만들 수 있어요.",
  },
} as const;
