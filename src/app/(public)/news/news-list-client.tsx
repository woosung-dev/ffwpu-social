  ...
  return (
    <>
      ...
      {list.items.length === 0 ? (
        ...
        <ul className="mt-8 grid [grid-template-columns:repeat(auto-fill,minmax(max(200px,calc(50%-12px)),1fr))] gap-6 md:grid-cols-2 md:gap-x-[18px] md:gap-y-12 lg:mt-10 lg:grid-cols-3 wide:gap-x-6">
          {list.items.map((item) => (
